 ...
 */
package org.iyunbo.meta.generated.tables.records;
...
public class AuthorRecord extends UpdatableRecordImpl<AuthorRecord> implements Record6<Integer, String, String, Date, Integer, Boolean> {

    private static final long serialVersionUID = 161128279;
     ...
     */
    public void setDistinguished(Boolean value) {
        set(5, value);
    }
    ...
    @Override
    public Row6<Integer, String, String, Date, Integer, Boolean> fieldsRow() {
        return (Row6) super.fieldsRow();
    }

    @Override
    public Row6<Integer, String, String, Date, Integer, Boolean> valuesRow() {
    ...
    @Override
    public AuthorRecord value6(Boolean value) {
        setDistinguished(value);
        return this;
    }

    @Override
    public AuthorRecord values(Integer value1, String value2, String value3, Date value4, Integer value5, Boolean value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AuthorRecord(Integer id, String firstName, String lastName, Date dateOfBirth, Integer yearOfBirth, Boolean distinguished) {
        super(Author.AUTHOR);
